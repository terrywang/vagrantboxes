...
This is a minimal base box built for [Vagrant](http://www.vagrantup.com/). Initially created using VirtualBox 4.2.2 (now 6.1.32) on Linux x86_64, guest additions installed. Packaged using Vagrant 2.2.19 (initially 1.3.4).
...
> **NOTE**: In November 2012, Arch Linux switched to `systemd` as its default init system. In January 2013 `initsripts` was removed from its official repositories. The base box is up-to-date as of 31 January, 2022 (UTC+11).

## Vagrant Base Box Information

1. Release: Installed using `archlinux-2013.02.01-dual.iso`
2. Kernel: `5.16.4`
3. VirtualBox Guest Additions `6.1.32` installed using packages: `virtualbox-guest-utils`

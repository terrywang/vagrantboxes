...
* SHA256: `0ed7682a045d9b1365aa4370016bc67921aea131f0caa51fb3d36cf1bcd7f9c6`

This is a minimal base box built for [Vagrant](http://www.vagrantup.com/). Initially created using VirtualBox 4.2.2 (now 5.2.6) on Linux x86_64, guest additions installed. Packaged using Vagrant 2.0.2 (initially 1.3.4).
...
> **NOTE**: In November 2012, Arch Linux switched to `systemd` as its default init system. In January 2013 `initsripts` was removed from its official repositories. The base box is up-to-date as of 15 February, 2018 (UTC+11).

## Vagrant Base Box Information

1. Release: Installed using `archlinux-2013.02.01-dual.iso`
2. Kernel: `4.15.3-1-ARCH`
3. VirtualBox Guest Additions 5.2.6 installed using packages: `virtualbox-guest-{dkms,utils}`
